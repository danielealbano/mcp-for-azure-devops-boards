...
- Do NOT hardcode organization-specific identifiers, credentials, endpoints, or secrets — all Azure context is resolved at runtime from CLI flags and the Azure credential chain.
